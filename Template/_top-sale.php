        ...
        <div class="owl-carousel owl-theme">
            ...
            <div class="item py-2">
                <div class="product font-rale">
                    <a href="<?php printf('%s?item_id=%s', 'product.php',  $item['item_id']); ?>"><img src="<?php echo isset($item['item_image']) ? $item['item_image'] : "Image not loading"; ?>" alt="Product 1" class="img-fluid"></a>
